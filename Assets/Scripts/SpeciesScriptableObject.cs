...
[CreateAssetMenu(fileName = "SpeciesScriptableObject", menuName = "Species")]
...
/// <param name="speciesName"></param>
    void Awake() {
        if (PlayerPrefs.GetString("Species Name") == "Pine") { Pine(); }
        else if (PlayerPrefs.GetString("Species Name") == "Gum") { Gum(); }
    }
